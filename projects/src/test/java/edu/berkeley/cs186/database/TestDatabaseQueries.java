...
public class TestDatabaseQueries {
  ...
  private static void createSchemas() throws DatabaseException {
    ...
    List<DataBox> studentSchemaTypes = new ArrayList<DataBox>();
    studentSchemaTypes.add(new IntDataBox());
    studentSchemaTypes.add(new StringDataBox(20));
    studentSchemaTypes.add(new StringDataBox(20));
    studentSchemaTypes.add(new FloatDataBox());
    ...
    List<DataBox> courseSchemaTypes = new ArrayList<DataBox>();
    courseSchemaTypes.add(new IntDataBox());
    courseSchemaTypes.add(new StringDataBox(20));
    courseSchemaTypes.add(new StringDataBox(20));
    ...
    List<DataBox> enrollmentSchemaTypes = new ArrayList<DataBox>();
    enrollmentSchemaTypes.add(new IntDataBox());
    enrollmentSchemaTypes.add(new IntDataBox());
